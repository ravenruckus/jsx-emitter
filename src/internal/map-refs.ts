...
import type { CodeType } from './plugins/process-code/types';
...
export const mapRefs = (component: JsonComponent, mapper: RefMapper): void => {
  const refSet = getRefs(component);

  // Include refs not used for bindings.
